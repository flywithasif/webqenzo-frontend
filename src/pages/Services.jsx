            ...
            {industries.map((industry) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#0B1220] text-sm text-white">
                    {industry.icon}
                  </span>
            ...
            {coreServices.map((service) => {
              ...
              return (
                <motion.div
                  ...
                  className="group rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm sm:p-9"
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-100 text-slate-700 transition-colors group-hover:bg-blue-600 group-hover:text-white">
                      <Icon size={20} />
                    </div>
                  ...
                  <div className="mt-7 flex items-center gap-2 text-sm font-semibold text-[#0B1220]">
                    Explore service
                    <ArrowRight
                      size={16}
        ...
        <div className="mx-auto grid max-w-[1400px] items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-9">
              <Link
                to="/get-quote"
                className="inline-flex items-center gap-2 rounded-full bg-[#0B1220] px-6 py-3.5 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-blue-600"
              >
          ...
          <div className="rounded-[30px] bg-[#060B14] p-3 shadow-2xl shadow-slate-300/30 sm:p-4">
            ...
            <div className="overflow-hidden rounded-[22px] bg-white">
              ...
              <div className="p-7 sm:p-10">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm font-black">STUDIO.</div>
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="rounded-[30px] border border-slate-200 bg-[#F7F8FA] p-5 sm:p-8">
                ...
                <div className="rounded-[22px] bg-white p-5 shadow-sm sm:p-7">
                  ...
                  <button className="mt-6 flex w-full items-center justify-center rounded-xl bg-[#0B1220] py-3 text-sm font-semibold text-white">
                    Confirm appointment
                  </button>
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-[28px] bg-[#0B1220] p-8 text-white">
      ...
      <section className="bg-white px-5 py-24 sm:px-8 lg:px-10 lg:py-32">
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="mt-16 grid items-center gap-5 lg:grid-cols-[1fr_auto_1fr]">
            ...
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#0B1220] text-white">
              <ArrowRight size={18} />
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              {[
                ...
                <div
                  key={name}
                  className="group flex items-center justify-between rounded-2xl border border-slate-200 p-5 transition hover:border-blue-200 hover:bg-blue-50/40"
                >
                  <div className="flex items-center gap-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-600 group-hover:bg-blue-600 group-hover:text-white">
                      <Icon size={18} />
                    </div>
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          <div className="mx-auto mt-14 grid max-w-5xl grid-cols-2 overflow-hidden rounded-[28px] border border-slate-200 bg-white sm:grid-cols-4">
            ...
            {technologies.map((technology, index) => (
              <div
                key={technology}
                className="flex min-h-32 items-center justify-center border-b border-r border-slate-200 p-5 text-center text-sm font-semibold text-slate-700 transition hover:bg-[#0B1220] hover:text-white"
              >
                <div>
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-end">
              ...
              <div>
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10">
                  <LifeBuoy size={21} className="text-cyan-400" />
                </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.035] p-4 text-sm text-slate-300"
                  >
                    <Check size={15} className="text-cyan-400" />
                    {item}
                  </div>
            ...
            {[
              ...
              <div
                ...
                className={`rounded-[28px] border p-7 ${
                  index === 1
                    ? "border-blue-200 bg-[#0B1220] text-white"
                    : "border-slate-200 bg-white"
                }`}
              >
                <p
                  className={`text-xs font-semibold uppercase tracking-[0.15em] ${
                    index === 1 ? "text-cyan-400" : "text-blue-600"
                  }`}
                >
                  {plan.name}
                </p>
                ...
                <Link
                  ...
                  className={`mt-8 inline-flex items-center gap-2 text-sm font-semibold ${
                    index === 1 ? "text-white" : "text-[#0B1220]"
                  }`}
                >
